...
public class MainActivity extends AppCompatActivity {
    ...
    public class drawingView extends View {
        ...
        Paint mBackGoundPaint, mTextPaint, getmTextPaintBack;
        ...
        public drawingView(Context context, int hours, int minutes, int seconds, int weekday, int date, float battery) {
            ...
            tf = Typeface.createFromAsset(getAssets(),"Gaby_Demo.ttf");

            mBackGoundPaint = new Paint();
            mBackGoundPaint.setColor(getResources().getColor(R.color.background));
            ...
            getmTextPaintBack = new Paint();
            getmTextPaintBack.setColor(ContextCompat.getColor(getApplicationContext(),R.color.text_back));
            getmTextPaintBack.setAntiAlias(true);
            getmTextPaintBack.setTextAlign(Paint.Align.CENTER);
            getmTextPaintBack.setTextSize(getResources().getDimension(R.dimen.text_size));
            getmTextPaintBack.setTypeface(tf);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(0,0, width, height, mBackGoundPaint);
...
//            canvas.drawText("00 00 00", centerX, centerY, getmTextPaintBack);
